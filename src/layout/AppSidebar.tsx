  ...
  const navItems: NavItem[] = [
    {
      ...
      subItems: [
        ...
        ...((user.role === ROLE.ADMIN || user.role === ROLE.MARKETING_MANAGER || user.role === ROLE.OWNER || user.role === ROLE.HOTEL_STAFF) ? [{ name: "Khách sạn", path: "/hotel", pro: false }] : []),
        ...((user.role === ROLE.ADMIN || user.role === ROLE.MARKETING_MANAGER || user.role === ROLE.OWNER || user.role === ROLE.HOTEL_STAFF) ? [{ name: "Phòng", path: "/room", pro: false }] : []),
        ...(user.role === ROLE.ADMIN ? [{ name: "Sân bay", path: "/airport", pro: false }] : []),
        ...((user.role === ROLE.ADMIN || user.role === ROLE.MARKETING_MANAGER || user.role === ROLE.FLIGHT_OPERATION_STAFF || user.role === ROLE.AIRLINE_TICKETING_STAFF) ? [{ name: "Hãng hàng không", path: "/airline", pro: false }] : []),
        ...((user.role === ROLE.ADMIN || user.role === ROLE.MARKETING_MANAGER || user.role === ROLE.FLIGHT_OPERATION_STAFF || user.role === ROLE.AIRLINE_TICKETING_STAFF) ? [{ name: "Máy bay", path: "/aircraft", pro: false }] : []),
        ...((user.role === ROLE.ADMIN || user.role === ROLE.MARKETING_MANAGER || user.role === ROLE.FLIGHT_OPERATION_STAFF || user.role === ROLE.AIRLINE_TICKETING_STAFF) ? [{ name: "Chuyến bay", path: "/flight", pro: false }] : []),
        ...((user.role === ROLE.ADMIN || user.role === ROLE.MARKETING_MANAGER || user.role === ROLE.DRIVER) ? [{ name: "Taxi", path: "/car", pro: false }] : []),
        ...((user.role === ROLE.ADMIN || user.role === ROLE.DRIVER) ? [{ name: "Chuyến taxi", path: "/car-journey", pro: false }] : []),
        ...((user.role === ROLE.ADMIN || user.role === ROLE.MARKETING_MANAGER || user.role === ROLE.EVENT_ORGANIZER) ? [{ name: "Hoạt động", path: "/activity", pro: false }] : []),
        ...((user.role === ROLE.ADMIN || user.role === ROLE.MARKETING_MANAGER || user.role === ROLE.EVENT_ORGANIZER) ? [{ name: "Gói hoạt động", path: "/activity-package", pro: false }] : []),
        ...((user.role === ROLE.ADMIN || user.role === ROLE.MARKETING_MANAGER || user.role === ROLE.EVENT_ORGANIZER) ? [{ name: "Ngày của gói hoạt động", path: "/activity-date", pro: false }] : []),
