...
import FlightSeatTable from "./FlightSeatTable";
  ...
  return (
    <>
      <ModalForm
        ...
        initialValues={
          dataInit?.id
            ? { ...dataInit, baggage_included: dataInit.baggage_included + "" }
            : {}
        }
      >
        <Row gutter={16}>
        ...
        <div className="flex flex-col gap-[50px] mt-[30px]">
          {dataInit?.id ? (
            ...
            <FlightLegTableCreate
              legsData={legsData}
              setLegsData={setLegsData}
            />
          )}
          {dataInit?.id ? (
            <SeatClassPricingTable
              flight={dataInit}
              canCreate={true}
              canUpdate={true}
              canDelete={true}
            ...
            <SeatClassPricingTableCreate
              seatClassesData={seatClassesData}
              setSeatClassesData={setSeatClassesData}
            />
          )}
        </div>
        {dataInit?.id && (
