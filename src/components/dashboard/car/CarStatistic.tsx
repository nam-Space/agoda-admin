...
const CarStatistic = ({ car }: any) => {
    ...
    useEffect(() => {
        ...
        handleGetPaymentOverview(`booking__service_type=${SERVICE_TYPE.CAR}${serviceQuery}&statistic_by=${selectedTime}`)

    }, [car, selectedTime, JSON.stringify(selectedRangeTime)])
    ...
    return (
        <div>
            ...
            <div className="mt-[20px]">
                <TableCustomerBooking serviceType={SERVICE_TYPE.CAR} carId={car?.id} minDate={selectedRangeTime.car[0]} maxDate={selectedRangeTime.car[1]} />
            </div>
        </div>
    )
}
