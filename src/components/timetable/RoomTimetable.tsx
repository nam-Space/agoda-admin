...
const RoomTimetable = () => {
    ...
    useEffect(() => {
        if (owner.value) {
            handleGetPayment(`current=1&pageSize=1000&owner_hotel_id=${owner.value}&booking__service_type=${SERVICE_TYPE.HOTEL}&status=${PAYMENT_STATUS.SUCCESS}&sort=created_at-asc`)
        }
    }, [owner])
