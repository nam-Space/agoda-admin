...
import ModalCarPromotion from "./ModalCarPromotion";
import ModalCarPromotionDetail from "./ModalCarPromotionDetail";
import { HiOutlineCursorClick } from "react-icons/hi";
import _ from "lodash";
// import ModalRoomPromotion from "./ModalPromotionRoom";

export default function CarPromotion() {
        ...
        },
        {
            ...
            render: (_value, entity, _index, _action) => (
                <Space>
                    ...
                    <Popconfirm
                        placement="leftTop"
                        title={"Xác nhận xóa khuyễn mãi taxi"}
                        description={"Bạn chắc chắn muốn xóa khuyễn mãi taxi"}
    ...
    const buildQuery = (params: any, _sort: any, _filter: any) => {
        ...
        temp += `&promotion_type=${PROMOTION_TYPE.CAR}`
    ...
    return (
        <div>
            ...
            />
            <ModalCarPromotionDetail promotion={dataInit} isModalOpen={isModalDetailOpen} setIsModalOpen={setIsModalDetailOpen} />
        </div>
    );
}
