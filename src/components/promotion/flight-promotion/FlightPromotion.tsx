...
export default function FlightPromotion(props: IProps) {
            ...
            render: (_value: any, entity: any, _index: any, _action: any) => (
                <Space>
                    ...
                    {canDelete && <Popconfirm
                        placement="leftTop"
                        title={"Xác nhận xóa khuyễn mãi chuyến bay"}
                        description={"Bạn chắc chắn muốn xóa khuyễn mãi chuyến bay"}
    ...
    return (
        <div>
            ...
            />
            <ModalFlightPromotionDetail promotion={dataInit} isModalOpen={isModalDetailOpen} setIsModalOpen={setIsModalDetailOpen} />
        </div>
    );
}
