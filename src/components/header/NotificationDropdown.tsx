						...
						<div className="border-t-[1px] border-[#f0f0f0] px-[10px] py-[10px] flex gap-[10px]">
							...
							<div className="flex-grow">
								<h3 className="text-gray-900 mb-[6px] leading-[18px]">
									...
									<span>Khách hàng </span><span className="font-bold text-blue-700">Nguyễn Dũng </span><span>đã đặt chuyến bay </span><span className="font-bold text-yellow-600">một chiều</span>: <span className="font-bold">Tân Sơn Nhất</span> → <span className="font-bold">Đà Nẵng</span>
								</h3>
